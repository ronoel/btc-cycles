...
- **Research snapshot**: rows/cards tagged with a `research:` date (currently `Aug 26, 2026`) come from a manual research pass (web + on-chain sources) and need periodic manual refresh — everything else recomputes live
